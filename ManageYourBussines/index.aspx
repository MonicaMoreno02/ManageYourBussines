                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <center>
                                                <asp:Label ID="Label3" runat="server" Text Style="color: blue;">Seleccione el tipo de Usuario que desea Ingresar</asp:Label>
                                            </center>
                                            <br />
                                            <br />

                                            <center>
                                                <asp:Button ID="btncliente" runat="server" class="btn btn-outline-primary" Text="cliente" OnClick="btncliente_Click" />
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <div>
                                            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal">Ingresa y conoce más</a>
                                        </div>
                                              </div>
                                </div>
                            </div>
                        ...
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <h6>
                                   ...
                                   <a class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal">Ingresa y conoce más
