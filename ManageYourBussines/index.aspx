            ...
            <ItemTemplate>
               ...
               <div class="card-deck mt-2">
                    <div class="card card-block col-md-4">
                         <div class="card-body">
      <tr><td><img src="<%#Eval("imagen") %>" width="145" height="145" alt="imagen de tarjeta" /></td></tr>
               <tr><td> <p> <%#Eval("nombre") %></p></td></tr>
               <tr> <p><tr> <%#Eval("precio") %></tr> </p></td> 
...
<div class="modal fade" id="myModal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <img src="<%#Eval("imagen") %>" width="145" height="145" alt="imagen de tarjeta" /></td></tr>
               <tr><td> <p> <%#Eval("nombre") %></p></td></tr>
               <tr> <p><tr> <%#Eval("precio") %></tr> </p></td> 
      </div>
