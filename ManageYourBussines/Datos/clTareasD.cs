    ...
    public class clTareasD
    {
        public List<clTareasE> mtdListarTareas()
        {
            ...
            for (int i = 0; i < catnReg; i++)
            {
                ...
                objDatosTareas.descripcionTarea = tblTareas.Rows[i]["descripcionTarea"].ToString();
