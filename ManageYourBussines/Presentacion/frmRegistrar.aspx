...
<body>
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="recursos/images/hero-bg.jpg" alt="">
    </div>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="frmProductos.aspx">Productos</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="frmAbout.aspx">About</a>
              </li>
              <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form_container">
                  ...
                  <asp:TextBox ID="txtDocumento" runat="server" Class="form-control"  placeholder="Documento "  TextMode="Number" name="required"></asp:TextBox>
              ...
              <asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control" placeholder="telefono " TextMode="Number" AutoCompleteType="Cellular"></asp:TextBox>



              <label for="direccion " class="form-label">Direccion :</label>

              <asp:TextBox ID="txtDireccion" runat="server" CssClass="form-control" placeholder="Direccion " TextMode="MultiLine"></asp:TextBox>

               <label for="email " class="form-label">Email :</label>

              <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" placeholder="Email " TextMode="MultiLine" AutoCompleteType="Email"></asp:TextBox>




              <asp:Button ID="btnRegistrar"   runat="server" Text="Registar" />
          </div>
        </div>
