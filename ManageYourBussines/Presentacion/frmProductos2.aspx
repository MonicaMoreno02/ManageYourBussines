        ...
        <div align="center">
            <div class="container mt-3 ">
                <div class="card" style="width: 400px">
                    <div align="center">
                        <asp:Image ID="Image1" runat="server" Width="100%" /></div>
                    <div class="card-body">
                        <h4 class="card-title" align="center" font-family="cursive">Producto:</h4>
                        <p class="card-text" align="center">
                            <asp:Label ID="lblID" runat="server" Text="Label"></asp:Label></p>
                        <p class="card-text" align="center">
                            <asp:Label ID="lbnombre" runat="server" Text="nombre:"></asp:Label>
                        <p class="card-text" align="center">
                            <asp:Label ID="lbDescripcion" runat="server" Text="Label"></asp:Label>
                        <p class="card-text" align="center">
                            <asp:Label ID="lbMaterial" runat="server" Text="Label"></asp:Label></p>
