...
<head>
    ...
    <title>Datos Pesonales</title>

    <!-- Font Icon -->
    <link rel="stylesheet" href="recursosedit/fonts/material-icon/css/material-design-iconic-font.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="recursosedit/css/style.css">
</head>
...
<body class="bg-gradient-primary">
    ...
    <script src="recursosedit/vendor/jquery/jquery.min.js"></script>
    <script src="recursosedit/js/main.js"></script>
