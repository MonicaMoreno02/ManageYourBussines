...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="hero_area">
        ...
        <%--Modal Sugerencias Cristian Salcedo--%>

        <div class="modal fade" id="ModalSugerencias" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <asp:Label ID="Label1" runat="server" Text="Tu opinion es muy importante para nosotros"></asp:Label>
                        <asp:TextBox ID="txtSugerencia" runat="server"></asp:TextBox>

                    </div>
                    <div class="modal-footer">
                        <asp:Button ID="btnEnviar" class="btn btn-primary btn-Enviar" runat="server" Text="Enviar" OnClick="btnEnviar_Click" />
                    </div>
                </div>
            </div>
        </div>
