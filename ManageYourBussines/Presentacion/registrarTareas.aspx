<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarTareas.aspx.cs" Inherits="ManageYourBussines.Presentacion.registrarTareas" %>
            ...
            <header class="header_section">
                <div class="container">
                   ...
                   c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                                ...
                                <a href="" class="order_online">Order Online
                                </a>
                            </div>
                        </div>
                    </nav>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form_container">
                            ...
                            <label for="nombreTareas" class="form-label">Nombre:</label>

                            <asp:TextBox ID="txtNombreT" runat="server" Class="form-control" name="uname" required placeholder="Documento " TextMode="Number"></asp:TextBox>
                            ...
                            <label for="Descripcion" class="form-label">descripciom:</label>

                            <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" name="uname" required placeholder="Nombres" TextMode="MultiLine"></asp:TextBox>
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Complete este Campo.</div>
